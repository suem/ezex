...
public class SendServer {
    ...
    public static void main(String[] args) throws IOException {
        ...
        ReceiveFiles.Response response = getResponse(base);
    ...
    public static ReceiveFiles.Response getResponse(File base) throws IOException {

        if (base.isFile()) {
            FileInfo i = new FileInfo(base);
            return ReceiveFiles.Response.from(new FileInfo(base));
        }
        ...
        return new ReceiveFiles.Response(fileInfoList.toArray(fileInfos));
